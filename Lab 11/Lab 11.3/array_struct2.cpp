...
// We want (index + 1) in the first one because we want to name the number of tax payers starting at 1. Index in the second occasion, index is pointing to the first array which starts at 0.
